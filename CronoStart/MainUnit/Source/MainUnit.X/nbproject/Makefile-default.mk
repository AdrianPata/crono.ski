...
SOURCEFILES_QUOTED_IF_SPACED=bluetooth_config.c bluetooth_tools.c config.c gsm_tool.c gsm_stateMachine.c gsm_config.c i2c_config.c i2c_tools.c irq_config.c irq_interrupt.c stopwatch_config.c stopwatch_tool.c timer_config.c timer_interrupt.c timer_tool.c tools_buffer.c tools_others.c uart_config.c uart_tools.c uart_interrupt.c uart_console.c main.c interrupts.c
...
# Source Files
SOURCEFILES=bluetooth_config.c bluetooth_tools.c config.c gsm_tool.c gsm_stateMachine.c gsm_config.c i2c_config.c i2c_tools.c irq_config.c irq_interrupt.c stopwatch_config.c stopwatch_tool.c timer_config.c timer_interrupt.c timer_tool.c tools_buffer.c tools_others.c uart_config.c uart_tools.c uart_interrupt.c uart_console.c main.c interrupts.c
